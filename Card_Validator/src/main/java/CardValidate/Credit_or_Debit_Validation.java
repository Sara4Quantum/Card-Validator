...
public class Credit_or_Debit_Validation { // Class declaration starts here
      
    @Autowired
    string_to_Array stArray; // Autowired dependency injection for the string_to_Array bean.

    // Method to validate credit or debit card.
    public int valida(input_collect inc) { // Method declaration starts here
        ...
        int[] card_no = stArray.convertStringToIntArray(inc.removeSpace(inc.getDigit()));
